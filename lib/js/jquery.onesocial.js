    ...
    var defaults =
    {
        ...
        facebook: {
            ...
            like:
            {
                ...
                href: 'this', // url, 'this' for current page, 'root' for main page
        ...
        twitter: {
            ...
            {
                text: '', // Tweet text
                url: 'this', // url, 'this' for current page, 'root' for main page
                ...
                'count-url': 'root', // explicit url, empty for current page or 'root' for your base url
